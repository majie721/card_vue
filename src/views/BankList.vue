  ...
  <div>
    ...
    <div v-if="loading">
      ...
      <van-popup
        ...
        :style="{ height: '350' }"
      >
        <div class="van-action-sheet__header van-hairline--bottom">
          选择收款账号类型
        </div>
        <van-radio-group
          v-for="(val, key) in accountTypes"
          :key="key"
          v-model="type"
        >
          <div
            class="account-type van-hairline--bottom"
      ...
      <van-button
        ...
        >添加账号</van-button
      >
      <p style="text-align: center;color: #f37b1d">
        如需添加对公账号,请联系客服处理~
      </p>
    </div>
  </div>
