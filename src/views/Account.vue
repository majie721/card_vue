      ...
      <div>
        <van-row class="user-base">
          ...
          <van-col span="15">
            ...
            <div class="text">
              <span class="lable">余额</span>:￥{{ balance }}
            </div>
            <div class="id">
              <span class="lable">账号ID</span>:{{ userInfo.id }}
            </div>
          </van-col>
        </van-row>
      </div>
      ...
      <div>
        <van-row class="user-info">
          <van-col span="6" @click="clickHandle('/withdraw')">
            <div class="buss-png">
              <van-icon
                class="iconfont van-icon iconyue1"
                dot
                color="#fbbd08"
              ></van-icon>
            </div>
          ...
          <van-col span="6" @click="clickHandle('/orders')">
            <div class="buss-png">
              <van-icon
                class="iconfont van-icon iconicon-"
                color="#1989fa"
              ></van-icon>
            </div>
          ...
          <van-col span="6" @click="clickHandle('/workOrders')">
            <div class="buss-png">
              <van-icon
                class="iconfont van-icon iconorder"
                color="#1cbbb4"
              ></van-icon>
            </div>
          ...
          <van-col span="6" @click="clickHandle('/messages')">
            <div class="buss-png">
              <van-icon
                v-if="unreadNum > 0"
                class="iconfont van-icon iconxiaoxi"
                :info="unreadNum"
                color="#39b54a"
              ></van-icon>
              <van-icon
