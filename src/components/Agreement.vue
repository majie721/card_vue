    ...
    >
          ...
          <div class="content">
            <div>
              <van-row type="flex" justify="center">
                ...
                <van-col span="19" class="a-text"
                  >我已阅读，理解并接受
                  <span @click="showProtol" class="x-text"
                    >「销卡大师卡密转让协议」</span
                  >和
                  <span @click="showInstructions" class="x-text"
                    >「销卡大师卡密回收说明」</span
                  ></van-col
                >
              </van-row>
            ...
            <div style="margin-top: 10px">
              <van-row type="flex" justify="center">
                ...
                <van-col span="19" class="a-text"
                  >我已确认该卡号卡密<span class="w-text">来源合法</span
                  >，如有问题，本人愿意承担一切法律责任
                </van-col>
              </van-row>
            </div>
      ...
      >
        ...
        <button
          ...
          :style="{ color: comfirmStatusColor }"
  ...
  methods: {
    ...
    showProtol: function() {
      this.$dialog.alert({
        title: "销卡大师卡密转让协议",
        message:
          "销卡大师卡密转让协议（以下称“本协议”）是销卡大师平台（以下称“销卡大师”）与销卡大师用户（以下称“用户”或“您”）就礼品卡或者卡密转让服务（或称”本服务”）所订立的有效合约。用户通过网络页面点击确认或以其他方式选择接受本协议，即表示用户与本平台已达成协议并同意接受本协议的全部约定内容。\n" +
          "\n" +
    ...
    showInstructions() {
      this.$dialog.alert({
        title: "销卡大师卡密回收说明",
        message:
          "1、礼品卡回收成功后，金额将打入您的账户余额中，您需要通过实名认证之后才可提现；\n" +
          "\n" +
