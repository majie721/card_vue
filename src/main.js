...
import {Icon, Tabbar, TabbarItem, Row, Col,Swipe, SwipeItem,Toast,NavBar ,Button,Tag,Field,Checkbox, CheckboxGroup,
    Image,Divider,Cell, CellGroup,Popup,RadioGroup, Radio,Switch,Collapse, CollapseItem,Search,Dialog,List,PullRefresh, Step, Steps } from 'vant';
...
Vue.use(Icon).use(Tabbar).use(TabbarItem).use(Row).use(Col).use(Swipe).use(SwipeItem)
    ...
    .use(Dialog).use(List).use(VueClipboard).use(PullRefresh).use(Step).use(Steps);
